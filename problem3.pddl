...
(:init
	...
	(is_connect combination_point bread_toaster2)
	
    (is_connect bread_toaster2 meat_heater )
    (is_connect bread_toaster2 combination_point)
	
    (is_connect meat_heater bread_toaster2)
	(is_connect meat_heater chop_board)
	
    (is_connect chop_board meat_heater )
	(is_connect chop_board bread_toaster)
	
	(is_connect bread_toaster chop_board)
